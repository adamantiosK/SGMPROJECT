...
public class playerLeft : MonoBehaviour {
    ...
    public GameObject _gameController, _playerRight, _canvasController;
    ...
    {
        if (_stateRemote.GameOn1 == true)
        {
            if (Input.GetKeyDown(KeyCode.Alpha1))
            {
                _stateRemote.GameOn1 = false;
                if(_stateRemote.First1 == true)
                {
                    _stateRemote.First2 = false;
                }

                if (_question.AnswerCurrentQuestionAndCheckIfCorrect(1) == true && _stateRemote.First1 == true)
                {
            ...
            if (Input.GetKeyDown(KeyCode.Alpha2))
            {
                ...
                if (_question.AnswerCurrentQuestionAndCheckIfCorrect(2) == true && _stateRemote.First1 == true)
                {
                    _stateRemote.Done = true;
                    _pr.GetHit();
                    _question.TimeBetweenQuestions();
            ...
            if (Input.GetKeyDown(KeyCode.Alpha3))
            {
                ...
                if (_question.AnswerCurrentQuestionAndCheckIfCorrect(3) == true && _stateRemote.First1 == true)
                {
                    _stateRemote.Done = true;
                    _pr.GetHit();
                    _question.TimeBetweenQuestions();
            ...
            if ((Input.GetKeyDown(KeyCode.Alpha1) || Input.GetKeyDown(KeyCode.Alpha2) || Input.GetKeyDown(KeyCode.Alpha3)) && _stateRemote.First1 == true)
            {
                _question.TimeBetweenQuestions();
            }
        }
